        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton href="/" tooltip="POS" asChild isActive={pathname === '/'}>
              <Link href="/" onClick={handleLinkClick}><LayoutGrid /><span>POS</span></Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton href="/wholesale" tooltip="Wholesale" asChild isActive={pathname === '/wholesale'}>
              <Link href="/wholesale" onClick={handleLinkClick}><Building /><span>Wholesale</span></Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
           <SidebarMenuItem>
            <SidebarMenuButton href="/sales" tooltip="Sales" asChild isActive={pathname === '/sales'}>
              <Link href="/sales" onClick={handleLinkClick}><ShoppingCart /><span>Sales</span></Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton href="/inventory" tooltip="Inventory" asChild isActive={pathname === '/inventory'}>
              <Link href="/inventory" onClick={handleLinkClick}><Boxes /><span>Inventory</span></Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton href="/reports" tooltip="Reports" asChild isActive={pathname === '/reports'}>
              <Link href="/reports" onClick={handleLinkClick}><BarChart3 /><span>Reports</span></Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
           <SidebarMenuItem>
            <SidebarMenuButton href="/loyalty" tooltip="Loyalty" asChild isActive={pathname === '/loyalty'}>
              <Link href="/loyalty" onClick={handleLinkClick}><Award /><span>Loyalty</span></Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton href="/expenses" tooltip="Expenses" asChild isActive={pathname === '/expenses'}>
              <Link href="/expenses" onClick={handleLinkClick}><Banknote /><span>Expenses</span></Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton href="/settings" tooltip="Settings" asChild isActive={pathname === '/settings'}>
              <Link href="/settings" onClick={handleLinkClick}><Settings /><span>Settings</span></Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
      </SidebarContent>
